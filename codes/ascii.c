...
Al declarar la variable como signed el maximo valor que puede representar es 0 1 1 1  1 1 1 1 = 127
ya que el bit mas significativo para indicar si el valor es positivo( 0 ) o negativo( 1 ), cuando
se incrementa en 1 el valor el nuevo estado de los bits sera 1 0 0 0  0 0 0 0 = -127 que es menor que 0,
